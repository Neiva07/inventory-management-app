...
import { createOrder, Order, OrderStatus, deleteOrder, getOrder, Item } from 'model/orders';
...
export const useOrderForm = (orderID?: string) => {
  ...
  //     ...queriedOrder,
  //     address: {
  //       ...queriedOrder.address,
  //       region: {
  //         value: queriedOrder.address.region,
  //         label: regionByCode.get(queriedOrder.address.region),
  //       },
  //     },
